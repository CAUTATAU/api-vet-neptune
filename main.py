...
def check_status():
    return {
        "message": "Bem-vindo à API da Clínica Veterinária usando Neptune Graph!"
    }
...
def buscar_tutor(id_tutor: str):
    return clinica_service.buscar_tutor(id_tutor)

@app.delete("/tutores/{id_tutor}")
def deletar_tutor(id_tutor: str):
    return clinica_service.deletar_tutor(id_tutor)
...
@app.get("/pets/{id_pet}")
def buscar_pet(id_pet: str):
    return clinica_service.buscar_pet(id_pet)

@app.delete("/pets/{id_pet}")
def deletar_pet(id_pet: str):
    return clinica_service.deletar_pet(id_pet)
...
@app.delete("/tutores/{id_tutor}/pets/{id_pet}")
def deletar_vinculo(id_tutor: str, id_pet: str):
